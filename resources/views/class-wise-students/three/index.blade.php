			...
			<div class="row">
				<div class="col-xs-2 col-sm-2 col-md-2 col-lg-4">
					<div class="page-header" style="margin-bottom:10px">
						<div class="page-title">
							<a href="{{ route('manage-students.index') }}" style="text-decoration: none;"><strong>Manage Students </strong></a><strong style="font-size:13px"> / Class Three Wise Students</strong>
						</div>								
					</div>
				</div>
				...
				<div class="col-xs-10 col-sm-10 col-md-10 col-lg-8" align="right">
					<div class="page-btn">
						...
						<div style="margin-top: 10px; margin-left:10px;">
						<a href="#" class="btn btn-warning" id="promoteAllSelectedRecord"> <i class="fa-solid fa-angle-double-right"> <strong></i> Promote Three to Four for Selected Students</strong></a>
						</div>
						</div>

						<div class="form-group d-flex align-items-center">
						<div style="margin-top: 10px; margin-left:10px;">
						 {!! Form::open(array('route' => 'class-three-wise-all-students-promote','method'=>'POST')) !!}
						...
						<div style="margin-top: 10px; margin-left:10px;">
						<button type="submit" class="btn btn-success" ><strong> <i class="fa-solid fa-angle-double-right"></i> Promote All ( Three to Four ) . Except Demoted Students</strong></button><br>
						{!! Form::close() !!}
						</div>
						</div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="form-box">
						  ...
						  <div id="demo" class="collapse">
								...
								{!! Form::open(array('url' => 'class-three-wise-students', 'method' => 'get', 'id'=>'searchform', 'autocomplete' => 'off', 'name'  => 'searchform', 'class' => 'needs-validation', 'novalidate')) !!}
									...
									<div class="text-center">
										{{--<a id="search_btn" href="{{ url('class-three-wise-students/') }}" class="btn submit-btn" type="submit">search</a>--}}
										<button type="submit" class="btn submit-btn" >Search</button>
										
										<a id="" href="{{ url('class-three-wise-students/') }}" class="btn  btn-danger" type="reset">Cancel</a>
									</div>
								{!! Form::close() !!}
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover" >
							   ...
							   @include("class-wise-students.three.index-pagination", ["data" => $data])
...
<script>
    $(function() {
        ...
        $("#promoteAllSelectedRecord").click(function(e) {
            ...
            $.ajax({
                url: "{{ route('selected-class-three-students-promote') }}", // Replace 'your_delete_route' with your actual route
                type: "GET",
                data: {
                    ids: all_ids,
