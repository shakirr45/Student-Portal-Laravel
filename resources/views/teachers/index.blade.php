                    ...
                    <div class="container">
                        ...
                        <div class="form-group">
                            ...
                            @foreach($saturdaysdataForTeachers as $saturday)
                                ...
                                Subjects: {{ !empty($saturday->subjects) ? $saturday->subjects : "" }} Time: {{ !empty($saturday->class_schedule) ? $saturday->class_schedule : "" }}</span><br>
                            @endforeach
                            ...
                            @foreach($sundaysdataForTeachers as $sunday)
                                ...
                                Subjects: {{ !empty($sunday->subjects) ? $sunday->subjects : "" }} Time: {{ !empty($sunday->class_schedule) ? $sunday->class_schedule : "" }}</span><br>
                            @endforeach
                            ...
                            @foreach($mondaysdataForTeachers as $monday)
                                ...
                                Subjects: {{ !empty($monday->subjects) ? $monday->subjects : "" }} Time: {{ !empty($monday->class_schedule) ? $monday->class_schedule : "" }}</span><br>
                            @endforeach
                            ...
                            @foreach($tuesdaysdataForTeachers as $tuesday)
                                ...
                                Subjects: {{ !empty($tuesday->subjects) ? $tuesday->subjects : "" }} Time: {{ !empty($tuesday->class_schedule) ? $tuesday->class_schedule : "" }}</span><br>
                            @endforeach
                            ...
                            @foreach($wednesdaysdataForTeachers as $wednesday)
                                ...
                                Subjects: {{ !empty($wednesday->subjects) ? $wednesday->subjects : "" }} Time: {{ !empty($wednesday->class_schedule) ? $wednesday->class_schedule : "" }}</span><br>
                            @endforeach
                            ...
                            @foreach($thursdaysdataForTeachers as $thursday)
                                ...
                                Subjects: {{ !empty($thursday->subjects) ? $thursday->subjects : "" }} Time: {{ !empty($thursday->class_schedule) ? $thursday->class_schedule : "" }}</span><br>
                            @endforeach
                            ...
                            @foreach($fridaysdataForTeachers as $friday)
                                ...
                                Subjects: {{ !empty($friday->subjects) ? $friday->subjects : "" }} Time: {{ !empty($friday->class_schedule) ? $friday->class_schedule : "" }}</span><br>
                            @endforeach
